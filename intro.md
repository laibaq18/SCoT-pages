...
NGoT Fixed (best for comparison) - Maintains a more consistent graph structure across time intervals, making it easier to compare semantic changes over time.

[img showing option 1]

Interval Fixed (best for overview and time-diff) - Focuses on interval-specific semantic relationships and highlights differences between time periods.

[img showing option 2]

NGoT nodes & GLOBAL edges (for manipulation) - Uses globally computed semantic connections, enabling more flexible graph exploration and manipulation.

[img showing option 3]

 
![The general structure](./images/intro-2.png "The general structure of the user interface" )

The image above shows the general structure of the web interface after rendering a graph for the query "happiness/NN". 
